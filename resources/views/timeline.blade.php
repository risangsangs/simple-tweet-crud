            ...
            <div class="card bg-white">
                <div class="card-body">
                    <form action="{{ route('tweets.store') }}" method="post">
                        @csrf
                        <textarea name="content" class="textarea textarea-bordered w-full" placeholder="apa yang kami pikirin?" rows="3"></textarea>
                    ...
                    <div class="card my-4 bg-white space-y-2">
                        <div class="card-body">
                            ...
                            <div class="text-end">
                                ...
                                @endcan
                                @can('delete', $tweet)
                                    {{-- <a href="{{route('tweets.destroy', $tweet->id)}}">Hapus</i></a> --}}
